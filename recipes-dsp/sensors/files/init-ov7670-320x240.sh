...
driver_init_ov7670 () {
	case $VIDEO_PATH in  
	  "$VIDEO0")
	    echo 1 > /sys/bus/i2c/devices/1-0021/reinit
	    ;;
	  "$VIDEO1")
	    echo 1 > /sys/bus/i2c/devices/2-0021/reinit
	    ;;
	  *)
	    USAGE_TEXT="Inits ov7670. Usage:\n\t 1, $VIDEO1 \n\t 0, $VIDEO0\n"
	    printf "$USAGE_TEXT"
...
if [ -f /sys/bus/i2c/devices/1-0021/reinit ] && [ -f /sys/bus/i2c/devices/2-0021/reinit ]; then
    driver_init_ov7670
else
	handle_init_ov7670
fi
